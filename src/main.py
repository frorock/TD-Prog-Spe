...
if __name__ == "__main__":
    ...
    # Mot-clé de recherche (en anglais, comme demandé dans le TD)
    keywords = "climate"

    # Chemin du fichier TSV final (sortie)
    out_path = "data/corpus.tsv"

    # Identifiants Reddit (récupérés depuis les variables d’environnement)
    reddit_credentials = {
        "client_id": os.getenv("REDDIT_CLIENT_ID"),
        "client_secret": os.getenv("REDDIT_CLIENT_SECRET"),
        # user_agent requis par l'API Reddit
        "user_agent": os.getenv("REDDIT_USER_AGENT", "M1-IR-TD3"),
        # "all" = recherche globale sur Reddit
        "subreddit": "all",
    }

    # Lancement du pipeline TD3 (acquisition + sauvegarde)
    ...
    # Petites vérifs simples (TD3) pour être sûr que ça tourne
    print("\n--- Vérification TD3 ---")
